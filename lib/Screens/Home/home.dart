...
import 'package:rhythm/CustomWidgets/custom_physics.dart';
...
import 'package:rhythm/Helpers/backup_restore.dart';
import 'package:rhythm/Helpers/supabase.dart';
import 'package:rhythm/Screens/Home/saavn.dart';
import 'package:rhythm/Screens/Library/library.dart';
import 'package:rhythm/Screens/LocalMusic/downed_songs.dart';
import 'package:rhythm/Screens/Search/search.dart';
import 'package:rhythm/Screens/Settings/setting.dart';
import 'package:rhythm/Screens/Top Charts/top.dart';
import 'package:rhythm/Screens/YouTube/youtube_home.dart';
    ...
    if (!checked && Theme.of(context).platform == TargetPlatform.android) {
      ...
      PackageInfo.fromPlatform().then((PackageInfo packageInfo) {
        ...
        if (autoBackup) {
          ...
          ExtStorageProvider.getExtStorage(dirName: 'Rhythm/Backups')
              .then((value) {
            createBackup(
              context,
              checked,
